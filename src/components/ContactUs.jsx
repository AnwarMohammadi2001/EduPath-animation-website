  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className="w-max flex gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-105 transition-all duration-500"
        >
          Submit <img src={assets.arrow_icon} alt="Arrow icon" width={14} />
        </button>
      </form>
    </div>
  );
